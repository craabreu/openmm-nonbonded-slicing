...
CudaOldVkFFT3D::CudaOldVkFFT3D(CudaContext& context, CUstream& stream, int xsize, int ysize, int zsize, int batch, bool realToComplex, CudaArray& in, CudaArray& out) :
...
CudaOldVkFFT3D::~CudaOldVkFFT3D() {
    deleteVkFFT(app);
    delete app;
}

void CudaOldVkFFT3D::execFFT(bool forward) {
